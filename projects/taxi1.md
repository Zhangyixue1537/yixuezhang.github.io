...
<div style="text-align: center; margin-top: 20px;">
  <img src="/figures/taxi.jpg" alt="Accessible taxi cover image" style="width:80%;">
  <div style="font-size: 14px; color: gray; margin-top: 5px;">Figure 1. Accessible taxi trips summary</div>
</div>
